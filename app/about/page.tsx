...
export const metadata: Metadata = {
  title: 'About Us | BigBoysTips',
  description: 'Learn more about BigBoysTips and our sports prediction service',
}
  ...
  return (
    <div className="relative mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto mt-28 z-50">
        <h1 className="text-4xl font-bold mb-20 text-white">About BigBoysTips</h1>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="text-lg mb-6">
            Welcome to BigBoysTips, your premier destination for expert sports predictions and analysis.
        ...
        <section className="border-t pt-8">
          <p className="text-center text-gray-600">
            ...
            <a href="mailto:contact@bigboystips.com" className="text-blue-600 hover:underline">
