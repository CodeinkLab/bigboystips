...
export default function ContactPage() {
  return (
    <div className=" relative mx-auto px-4 py-12">
      ...
      <div className="container w-full mx-auto mt-28 z-50">
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="group hover:bg-gray-50 p-3 rounded-lg transition-all duration-300">
                  <p className="flex items-center space-x-4">
                    ...
                    <a href="tel:+233542810847" target='_blank' className="text-gray-600 hover:text-orange-600 transition-colors duration-300">
                      +233 542 810 847
                    </a>
                  </p>
                </div>
                ...
                <div className="group hover:bg-gray-50 p-3 rounded-lg transition-all duration-300">
                  <p className="flex items-center space-x-4">
                    ...
                    <a href="https://wa.me/233542810847" target='_blank' className="text-gray-600 hover:text-orange-600 transition-colors duration-300">
                      WhatsApp
                    </a>
                  </p>
                </div>
                ...
                <div className="group hover:bg-gray-50 p-3 rounded-lg transition-all duration-300">
                  <p className="flex items-center space-x-4">
                    ...
                    <a href="mailto:senanick1333@gmail.com" target='_blank' className="text-gray-600 hover:text-orange-600 transition-colors duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="group hover:bg-gray-50 p-3 rounded-lg transition-all duration-300">
                  <p className="flex items-start space-x-4">
                    ...
                    <span suppressHydrationWarning className="flex flex-col space-y-2">
                      <a href="https://t.me/bigboyzg" target='_blank' className="text-gray-600 hover:text-orange-500 transition-colors duration-300">Channel</a>
                      <a href="https://t.me/NICKSENA1" target='_blank' className="text-gray-600 hover:text-orange-500 transition-colors duration-300">@NICKSENA1</a>
                      <a href="https://t.me/+S5cnced294syODc1" target='_blank' className="text-gray-600 hover:text-orange-500 transition-colors duration-300">Group Link</a>
                    </span>
                  </p>
                </div>
                ...
                <div className="group hover:bg-gray-50 p-3 rounded-lg transition-all duration-300">
                  <p className="flex items-center space-x-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                    </svg>
                    <a href="https://twitter.com/SenaNick1" target='_blank' className="text-gray-600 hover:text-orange-500 transition-colors duration-300">
                      @SenaNick1
                    </a>
                  </p>
                </div>
      ...
      <div className="container w-full mx-auto p-6 lg:p-4">
        {/* Header */}
        <div className="mb-8">
