...
export const metadata: Metadata = {
  title: 'User Dashboard | BigBoysTips',
  description: 'View your predictions and account information',
}

export default function DashboardPage() {
  return (
    <div className="p-6 lg:p-8 w-full mx-auto z-50">
      {/* Welcome section */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Welcome back, John!</h1>
        <p className="text-gray-600 mt-1">Here&apos;s what&apos;s happening with your predictions today.</p>
      </div>
      ...
      {/* Recent predictions and activity */}
