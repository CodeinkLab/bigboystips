      ...
      <div className="p-4 w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 mb-8">
          <StatCard
            ...
            trend={safe(() => summary.overview.userGrowthRate, 0)}
            color="orange"
          />
          <StatCard
            icon={Target}
            ...
            trend={safe(() => summary.overview.predictionGrowthRate, 0)}
            color="teal"
          />
          <StatCard
            icon={DollarSign}
            ...
            trend={safe(() => summary.overview.revenueGrowth, 0)}
            color="purple"
          />
          <StatCard
            icon={Crown}
            ...
            trend={safe(() => summary.overview.subscriptionGrowthRate, 0)}
            color="rose"
          />
          <StatCard
            icon={TrendingUp}
            ...
            trend={safe(() => summary.todayMetrics.todayRevenueGrowth, 0)}
            color="indigo"
          />
        </div>
