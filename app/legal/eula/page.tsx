            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="prose prose-orange max-w-none">
                <section id="overview" className={activeSection === 'overview' ? '' : 'hidden'}>
                  <h2>1. Overview</h2>
                  <p>This End User License Agreement (&ldquo;EULA&rdquo;) is a legal agreement between you and BigBoysTips governing the use of our platform and services. By using our services, you agree to be bound by this EULA.</p>
                </section>
                ...
                <section id="ownership" className={activeSection === 'ownership' ? '' : 'hidden'}>
                  ...
                  <p>are and will remain the exclusive property of BigBoysTips and its licensors.</p>
