            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="prose prose-orange max-w-none">
                <section id="overview" className={activeSection === 'overview' ? '' : 'hidden'}>
                  <h2>1. Overview</h2>
                  <p>At BigBoysTips, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.</p>
                </section>
