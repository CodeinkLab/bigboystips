            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="prose prose-orange max-w-none">
                <section id="overview" className={activeSection === 'overview' ? '' : 'hidden'}>
                  <h2>1. Overview</h2>
                  <p>Welcome to BigBoysTips ("we," "our," or "us"). By accessing or using our website, mobile applications, and services, you agree to be bound by these Terms of Service ("Terms"). Please read these terms carefully before using our services.</p>
