                ...
                <section id="overview" className={activeSection === 'overview' ? '' : 'hidden'}>
                  ...
                  <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-6">
                    <p className="text-orange-700">
                      BigBoysTips provides sports betting predictions and analysis for informational purposes only. We are not a gambling operator or bookmaker, and we do not accept or place bets.
                    </p>
                  </div>
                ...
                <section id="liability" className={activeSection === 'liability' ? '' : 'hidden'}>
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
                    <p className="text-red-700">
                      BigBoysTips is not liable for any financial losses incurred from using our predictions or analysis. Use our services at your own risk.
                    </p>
                  </div>
