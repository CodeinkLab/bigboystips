    ...
    return (
        <div className="relative mx-auto px-4 py-12">
            ...
            <div className="flex flex-col max-w-[95rem] w-full mx-auto gap-16 mt-16">
                {content.isSubscriptionActive && <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 h-max" onMouseEnter={() => setTableIndex(0)}>
                ...
                {content.isSubscriptionActive && <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 h-max" onMouseEnter={() => setTableIndex(1)}>
                    <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                        <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                ...
                                {BetOfTheDayGames
                                    .map((prediction, index) => (
                                        <tr key={index} className="hover:bg-gray-50 transition-colors odd:bg-neutral-100">
                                            ...
                                            </td>                                            <td className="px-6 py-2 whitespace-nowrap">
                                                {prediction.result === "WON" && <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    Won ✓
                                                </span>}
                                                {prediction.result === "LOST" && <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                ...
                {content.isSubscriptionActive && <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 h-max" onMouseEnter={() => setTableIndex(2)}>
                    <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                        <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                ...
                {content.isSubscriptionActive && <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 h-max" onMouseEnter={() => setTableIndex(3)}>
                    <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                        <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                            Draw Game Predictions
                            <svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 13l3.293-6.586a1 1 0 011.707-.117L10 10.382l2.999-4.085a1 1 0 011.707.117L18 13H2zm0 2a1 1 0 001 1h14a1 1 0 001-1v-1H2v1z" />
                            </svg>
                        </h3>
                ...
                {content.isSubscriptionActive && <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-yellow-200 h-max" onMouseEnter={() => setTableIndex(4)}>
                    <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                        <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
