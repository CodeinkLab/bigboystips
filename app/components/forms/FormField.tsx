                ...
                <div className="bg-white">
                  {countryOptions?.sort((a, b) => a.label.localeCompare(b.label)).map((option) => (
                    <button
                      ...
                      className={`w-full px-6 py-2 text-left text-sm hover:bg-orange-50 hover:text-orange-600 ${
                        selectedValue === option.value ? 'bg-orange-100 text-orange-600' : 'text-gray-700'
                      }`}
                    >
                      {option.label}
                    </button>
